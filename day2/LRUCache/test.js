...
lru.put(2, 4);
lru.put(3, 4);
utils.test(lru.get, (a, b) => a == b, [[4]], [-1]);
utils.test(lru.get, (a, b) => a == b, [[2]], [4]);
lru.put(4, 5);
lru.put(3, 7);
utils.test(lru.get, (a, b) => a == b, [[2]], [4]);
utils.test(lru.get, (a, b) => a == b, [[3]], [7]);
utils.test(lru.get, (a, b) => a == b, [[1]], [-1]);
...
lruRefactor.put(2, 4);
lruRefactor.put(3, 4);
utils.test(lruRefactor.get, (a, b) => a == b, [[4]], [-1]);
utils.test(lruRefactor.get, (a, b) => a == b, [[2]], [4]);
lruRefactor.put(4, 5);
lruRefactor.put(3, 7);
utils.test(lruRefactor.get, (a, b) => a == b, [[2]], [4]);
utils.test(lruRefactor.get, (a, b) => a == b, [[3]], [7]);
utils.test(lruRefactor.get, (a, b) => a == b, [[1]], [-1]);
